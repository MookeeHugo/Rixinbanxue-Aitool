                                        ...
                                        >
                                          <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                              ...
                                              {'error' in step && step.error && <p className="text-xs text-red-600 mt-1">{step.error}</p>}
                                            </div>
                                          </div>
                                  ...
                                  {task.imageUrls.length > 0 ? (
                                    <div className="grid grid-cols-2 gap-4">
                                      {task.imageUrls.map((url, index) => (
                                        <div key={index} className="overflow-hidden rounded-lg border-2 bg-gray-50">
                                          <Image
                                          ...
                                          />
                                          <div className="border-t-2 bg-white p-2 text-center text-sm text-gray-600">
                                            Page {index + 1}
                                          </div>
                                        </div>
                                      ))}
